...
#PATH
const PATH_ROOT = 'E:' . DIRECTORY_SEPARATOR . 'TRABALHO' . DIRECTORY_SEPARATOR . 'SERVIDOR';
const PATH_APP = DIRECTORY_SEPARATOR . 'App';
const DIR_VENDOR = DIRECTORY_SEPARATOR . 'Libraries';
...
const DIR_MIGRATION =  PATH_APP . DIRECTORY_SEPARATOR . 'Migrations';
